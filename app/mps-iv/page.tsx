      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              MPS IV requires regular monitoring and coordinated care across
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-2">
            <article className="rounded-3xl bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 space-y-4 leading-7 text-slate-600">
                <p>
                  ...
                  rehabilitation, respiratory support and regular specialist
                  review.
                </p>

                <p>
                  Enzyme replacement therapy may be considered for eligible
                  patients under specialist supervision.
                </p>

                <p>
                  Treatment decisions should be made by a metabolic disease
                  team familiar with MPS IV.
                </p>
              </div>
            </article>
            ...
            <article className="rounded-3xl bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 space-y-4 leading-7 text-slate-600">
                <p>
                  People with MPS IV may have airway, neck and spinal
                  considerations that can affect anaesthesia.
                </p>
                ...
                <p>
                  Previous reports, imaging and specialist recommendations
                  should be shared before any planned procedure.
                </p>
              </div>
            </article>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600">
                ...
                mobility support, flexible seating and individual school
                planning.
              </p>
            </div>

            <div className="space-y-4">
              {schoolSupportItems.map((item) => (
                <div
                  key={item}
